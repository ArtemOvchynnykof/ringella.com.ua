...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'nileforest-panel ' ); ?> >
	...
	<?php if ( has_post_thumbnail() ) :
		...
		$thumbnail_attributes = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'nileforest-featured-image' );
	...
	<div class="panel-content">		
			<?php				
				$page_title = get_post_meta( get_the_ID(), 'meta-box-page-title', true );
				if($page_title !="hide"):
				?>
			<div class="container">
				<div class="row">
