...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<input type="search" id="<?php echo esc_attr($unique_id); ?>" class="search-field" placeholder="<?php echo esc_attr( 'Search &hellip;','placeholder','philos' ); ?>" value="<?php echo esc_attr(get_search_query()); ?>" name="s" />
